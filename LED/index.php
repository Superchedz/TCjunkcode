 ...
 <header class="navbar navbar-static-top bs-docs-nav" id="top" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="#" class="navbar-brand">Boiler Control</a>
    </div>
...
<div class="jumbotron" id="content">
    <div class="container">
          <h1>Welcome to <img src='./img/flame.png' class='img-thumbnail img-responsive' alt='Login'/> Total Control 9000</h1>
            <p>Total Control 9000 is a web enabled system to allow you to easily manage and monitor a multi-zone heating system</p>
    </div>
</div>
...
if (isset($_GET["err"])) {
    ...
    if ($error == "wrongcredentials") {
        ...
        echo "<div class='alert alert-success alert-dismissible' role='alert'> <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>You have been successfully logged out from Boiler Control 9000 portal.</div>";
    }
}
?>
