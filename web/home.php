...
<div class="jumbotron" id="content">
    <div class="container">
          <p><img src='./img/flame.png' class='img-thumbnail img-responsive' alt='Home'/> Total Control 9000 - manage the system settings, monitor active zones and set controls (Release v1.2) </p>
    </div>
</div>
