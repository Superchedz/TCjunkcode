...
if ($result->num_rows > 0) {
    ...
    $sql1 = "insert into $tbl_name (Zone_ID, Zone_Name, Zone_Active_Ind, Zone_Current_State_Ind, Zone_Last_Temp_Reading, Zone_Last_Temp_Reading_Dtime, Zone_Sensor_ID, Zone_Offset, Pi_Pin_num) value($NewId , '$scparam_zonename', 'N', 'OFF', 0, current_date, '$scparam_zonesensor', $scparam_offset, $scparam_pinnum)";
